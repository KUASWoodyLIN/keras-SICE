...
from utils.callback import SavePredImageEpoch, SavePredImageBestStep1, CustomReduceLR, SaveModelEpochs, SaveOutputHistogram
from model.sice import create_detail_and_luminance_model
from preprocessing.image_processing import load_data_path_v2, load_data_path, data_generator_wapper_step1, create_testing_data, image_process
...
def main():
    ...
    train_generator = data_generator_wapper_step1(x_train, y_train, batch_size)
    ...
    # Create model
    model, pred_model = create_detail_and_luminance_model()
    ...
    save_img_best = SavePredImageBestStep1(callback, x_test, x_name, pred_model)
    ...
    model.fit_generator(train_generator,
                        ...
                        callbacks=[save_img_best, checkpoint, checkpoint_2, callback])
